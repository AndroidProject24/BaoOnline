...
public class UserCacheImpl implements UserCache {
  ...
  public void put(UserEntity userEntity) {
    if (userEntity != null) {
      File userEntitiyFile = this.buildFile(Integer.parseInt(userEntity.getId()));
      if (!isCached(Integer.parseInt(userEntity.getId()))) {
  ...
  private void executeAsynchronously(Runnable runnable) {
    ...
    Log.wtf("showUserDetailsInView=",(getMainLooper() == myLooper())+"");
